               ...
               '<div class="modal-dialog">' +
                 '<div class="modal-content">' +
                   ...
                   '<div class="modal-header">' +
                     ...
                     '<h4 class="modal-title"><i class="glyphicon glyphicon-save"></i> ' + title + '</h4>' +
                   '</div>' : ''
                   ) +
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row-fluid note-group-select-from-files">' +
                   ...
                   '</div>';
        var footer = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled><i class="glyphicon glyphicon-save"></i> ' + lang.image.insert + '</button>';
      ...
      link: function (lang, options) {
        ...
        var footer = '<button href="#" class="btn btn-primary note-link-btn disabled" disabled><i class="glyphicon glyphicon-save"></i> ' + lang.link.insert + '</button>';
