...
<button type="button" id="submit-module-slideshow" data-toggle="tooltip" title="Save" class="btn btn-primary"><i class="fa fa-save"></i></button>
...
<div class="container-fluid">
  <div class="panel panel-default">
      ...
      <div class="panel-body">
        <p id="message"></p>
        <form action="#" method="post" enctype="multipart/form-data" id="form-module-slideshow" class="form-horizontal">
...
$(document).ready(function() {
  requestSubmitForm('submit-module-slideshow', 'form-module-slideshow', "<?php echo $data->action; ?>");
});
</script>
@endsection