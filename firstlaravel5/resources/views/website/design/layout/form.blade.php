            ...
            <tbody>
              ...
              <tr id="route-row<?php echo $route_row; ?>">
                <td class="text-left"><select name="layout_route[<?php echo $route_row; ?>][store_id]" class="form-control">
                    <option value="0"><?php echo $data->text_default; ?></option>
                    <?php foreach ($data->websites as $website) { ?>
                    <?php if ($website['website_id'] == $layout_route['store_id']) { ?>
...
function addRoute() {
  ...
  html += '  <option value="0"><?php echo $data->text_default; ?></option>';
  <?php foreach ($data->websites as $website) { ?>
  html += '<option value="<?php echo $website['store_id']; ?>"><?php echo addslashes($website['name']); ?></option>';
  <?php } ?>   
  html += '  </select></td>';
