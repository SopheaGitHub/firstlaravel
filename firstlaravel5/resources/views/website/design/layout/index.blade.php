...
<a href="<?php echo $data->add_layout; ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
$(document).ready(function() {
  ...
  paginateListAction('render-layout', "<?php echo $data->actionlist; ?>");
