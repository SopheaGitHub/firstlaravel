...
<a href="<?php echo $data->add_category; ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
$(document).ready(function() {
  ...
  paginateListAction('render-category', "<?php echo $data->actionlist; ?>");
