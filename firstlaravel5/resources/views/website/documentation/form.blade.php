...
<button type="button" id="submit-documentation" data-toggle="tooltip" title="Save" class="btn btn-primary"><i class="fa fa-save"></i></button>
...
<div class="container-fluid">
  <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="#" method="post" enctype="multipart/form-data" id="form-documentation" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language->language_id; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="documentation_description[<?php echo $language->language_id; ?>][name]" value="<?php echo $data->documentation_description[$language->language_id]['name']; ?>" placeholder="<?php echo $data->entry_name; ?>" id="input-name<?php echo $language->language_id; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="documentation_description[<?php echo $language->language_id; ?>][description]" placeholder="<?php echo $data->entry_description; ?>" id="input-description<?php echo $language->language_id; ?>" class="text_summernote form-control"><?php echo $data->documentation_description[$language->language_id]['description']; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="documentation_description[<?php echo $language->language_id; ?>][meta_title]" value="<?php echo $data->documentation_description[$language->language_id]['meta_title']; ?>" placeholder="<?php echo $data->entry_meta_title; ?>" id="input-meta-title<?php echo $language->language_id; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="documentation_description[<?php echo $language->language_id; ?>][meta_description]" rows="5" placeholder="<?php echo $data->entry_meta_description; ?>" id="input-meta-description<?php echo $language->language_id; ?>" class="form-control"><?php echo $data->documentation_description[$language->language_id]['meta_description']; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="documentation_description[<?php echo $language->language_id; ?>][meta_keyword]" rows="5" placeholder="<?php echo $data->entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language->language_id; ?>" class="form-control"><?php echo $data->documentation_description[$language->language_id]['meta_description']; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
                  ...
                  <select name="status" id="input-status" class="form-control">
                    <?php
                      foreach ($data->status as $key => $status) { ?>
                        <option <?php echo (($key == $data->documentation_status)? 'selected="selected"':''); ?> value="<?php echo $key; ?>"><?php echo $status; ?></option>
                      <?php }
                    ?>
                  </select>
                </div>
            ...
            <div class="tab-pane" id="tab-design">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="documentation_layout[0]" class="form-control">
                    <option value="0"></option>
                    <?php
                      foreach ($data->layouts as $layout_id => $layout_name) { ?>
                        <option <?php echo ((count($data->documentation_layout) > 0)? (($layout_id == $data->documentation_layout[0]->layout_id)? 'selected="selected"':''):''); ?> value="<?php echo $layout_id; ?>"><?php echo $layout_name; ?></option>
                    <?php  }
                    ?>
                  </select>
                </div>
...
<script type="text/javascript">
$(document).on('mouseover', '#submit-documentation', function(e) {
  <?php foreach ($data->languages as $language) { ?>
    $('#input-description<?php echo $language->language_id; ?>').val($('#input-description<?php echo $language->language_id; ?>').code());
  <?php } ?>
});
$(document).ready(function() {
  requestSubmitForm('submit-documentation', 'form-documentation', "<?php echo $data->action; ?>");
});
</script>
@endsection