...
<a href="<?php echo $data->add_information; ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
$(document).ready(function() {
  ...
  paginateListAction('render-information', "<?php echo $data->actionlist; ?>");
