...
<a href="<?php echo $data->add_country; ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
...
$(document).ready(function() {
  ...
  paginateListAction('render-country', "<?php echo $data->actionlist; ?>");
